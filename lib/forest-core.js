(function (global, factory) {
  ...
  function updateObject(uid, update, full) {
    ...
    var notifiable = full || update.Timer || changed && Object.keys(update).filter(function (e) {
  ...
  function mergeUpdate(o, update, full) {
    ...
    var p = Object.assign({ UID: o.UID, Peer: o.Peer, Notify: o.Notify, Version: o.Version }, full ? {} : o, update);
