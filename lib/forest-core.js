(function (global, factory) {
  ...
  var localProps = ['Notifying', 'Timer', 'TimerId', 'Evaluator', 'ReactNotify', 'userState'];
  ...
  function doEvaluate(uid) {
    ...
    if (!o.Evaluator || typeof o.Evaluator !== 'function') {
      console.error('no Evaluator function!', o);return;
    }
    for (var i = 0; i < 4; i++) {
