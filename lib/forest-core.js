(function (global, factory) {
  ...
  function setObjectState(uid, state) {
    var newState = Object.assign({}, objects[uid], state);
  ...
  function stateAccess(u, p, m) {
    var r = function (uid, path, match) {
      var state = objects[uid];
  ...
  function doPost(o) {
    var data = _lodash2.default.pick(o, 'moderated');
  ...
  function doEvaluate(uid) {
    ...
    for (var i = 0; i < 4; i++) {
      ...
      var newState = o.evaluate(stateAccess.bind(null, uid));
