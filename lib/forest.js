(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['module', 'exports', 'react', 'react-native', 'react-dom', 'superagent', 'lodash', './forest-core'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('react'), require('react-native'), require('react-dom'), require('superagent'), require('lodash'), require('./forest-core'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.react, global.reactNative, global.reactDom, global.superagent, global.lodash, global.forestCore);
    global.forest = mod.exports;
  }
})(this, function (module, exports, _react, _reactNative, _reactDom, _superagent, _lodash, _forestCore) {
  'use strict';
  ...
  var notifyUID = _forestCore2.default.makeUID();
  ...
  function doPost(o) {
    ...
    var uid = o.Notifying;
    return _superagent2.default.post(uid).timeout({ response: 9000, deadline: 10000 }).set('Notify', notifyUID).send(data).then(function (x) {
      return x;
    }).catch(function (e) {
  ...
  var Forest = function (_Component) {
    ...
    _createClass(Forest, null, [{
      key: 'wsInit',
      value: function wsInit(port) {
        var ws = new WebSocket('ws://localhost:' + port);

        ws.onopen = function () {
          ws.send(JSON.stringify({ notifyUID: notifyUID }));
        };
