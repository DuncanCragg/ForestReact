(function (global, factory) {
  ...
  function evalTodo(object) {
    var todoSubmitted = object('user-state.newTodo-submitted?');
    return [!object('user-state.newTodo-submitted') && { newTodo: object('user-state.newTodo') || '' }, todoSubmitted && { newTodo: '',
      ...
      completedTodos: object('todos', { match: { completed: true } }) }, true && { clearCompleted: object('user-state.clearCompleted') }, true && { toggleAll: !object('activeTodos') }];
  }
