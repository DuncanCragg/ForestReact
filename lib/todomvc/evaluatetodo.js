(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['react', '../forest-web', './rendertodo'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('react'), require('../forest-web'), require('./rendertodo'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.react, global.forestWeb, global.rendertodo);
    global.evaluatetodo = mod.exports;
  }
})(this, function (_react, _forestWeb, _rendertodo) {
  'use strict';
  ...
  var uids = _forestWeb2.default.cacheObjects([{ Evaluator: evalTodo,
    is: 'todoapp',
    newTodo: '',
    nowShowing: 'all',
    todos: []
  ...
  function evalTodo(object) {
    ...
    return Object.assign({}, !object('userState.newTodo-submitted') && { newTodo: object('userState.newTodo') || '' }, todoSubmitted && { newTodo: '',
      todos: object('todos').concat([_forestWeb2.default.spawnObject({ Evaluator: evalTodoItem,
        is: 'todoitem',
      ...
      completedTodos: object('todos', { match: { completed: true } }) }, true && { clearCompleted: object('userState.clearCompleted') }, true && { toggleAll: object('activeTodos') == null || object('activeTodos').length == 0 }, true && { creating: object('userState.newTodo-submitted') });
  }
  ...
  _forestWeb2.default.renderDOM(_react2.default.createElement(_rendertodo2.default, { uid: uids[0], key: uids[0] }));
});