  ...
  var TodoApp = function (_Forest) {
    ...
    _createClass(TodoApp, [{
      ...
      value: function render() {
        var all = [].concat(this.object('todos') || []);
        var active = [].concat(this.object('activeTodos') || []);
        var completed = [].concat(this.object('completedTodos') || []);
        ...
        return _react2.default.createElement(
          ...
          shownTodos && shownTodos.length != 0 && _react2.default.createElement(
            'section',
            { className: 'main' },
          ...
          (numactive != 0 || numcompleted != 0) && _react2.default.createElement(
            ...
            _react2.default.createElement(
              _forestWeb.ForestWidget,
              { onRead: this.onRead, onChange: this.onChange, name: 'clearCompleted' },
              function (_ref) {
                var getWebButtonProps = _ref.getWebButtonProps;
                return _react2.default.createElement(
                  'button',
                  _extends({}, getWebButtonProps(), { className: 'clear-completed' }),
                  'Clear mango'
                );
              }
            )
      ...
      value: function render() {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _forestWeb.ForestWidget,
              { onRead: this.onRead, onChange: this.onChange, name: 'destroy' },
              function (_ref2) {
                var getWebButtonProps = _ref2.getWebButtonProps;
                return _react2.default.createElement('button', _extends({}, getWebButtonProps(), { className: 'destroy' }));
              }
            )
          ),
