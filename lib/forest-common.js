(function (global, factory) {
  ...
  var ForestCommon = function (_Component) {
    ...
    _createClass(ForestCommon, null, [{
      ...
      key: 'wsInit',
      value: function wsInit(prot, host, port, path) {
        var _this2 = this;

        var urlselect = { http: 'ws://' + host + ':' + port + '/' + path,
          https: 'wss://' + host + '/' + path };
        ...
        ws.onclose = function () {
          ...
          setTimeout(function () {
            ...
            _this2.wsInit(prot, host, port, path);
          }, timeout);
        };
      ...
      value: function stringify(o) {
        return _forestCore2.default.stringify(o);
      }
    }, {
      key: 'dumpCache',
      value: function dumpCache(slowness) {
        return _forestCore2.default.dumpCache(slowness);
      }
    }, {
        ...
        var Consumer = function Consumer(props) {
          return _react2.default.createElement(
            ...
            function (_ref) {
              ...
              return _react2.default.createElement(Component, _extends({ object: object, onRead: onRead, onChange: onChange, onKeyDown: onKeyDown }, props));
            }
          );
        };
        return Consumer;
  ...
  var _initialiseProps = function _initialiseProps() {
    ...
    this.Provider = function (props) {
      return _react2.default.createElement(
        Context.Provider,
        { value: {
            object: _this4.object,
            onRead: _this4.onRead,
  ...
  var ForestWidget = function (_Component2) {
    ...
    function ForestWidget() {
      ...
      return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref2 = ForestWidget.__proto__ || Object.getPrototypeOf(ForestWidget)).call.apply(_ref2, [this].concat(args))), _this3), _this3.onChange = function (value) {
      ...
      }, _this3.KEY_ENTER = 13, _this3.getTextFieldProps = function () {
        return {
          type: 'text',
          onChange: function onChange(e) {
            return _this3.props.onChange(_this3.props.name, e.target.value);
          },
          onKeyDown: function onKeyDown(e) {
            return _this3.props.onKeyDown(_this3.props.name, e);
          },
          value: _this3.props.onRead(_this3.props.name) || '',
        ...
        return {
          ...
          getTextFieldProps: _this3.getTextFieldProps
        };
