(function (global, factory) {
  ...
  function doPost(o, url) {
    ...
    return _superagent2.default.post(url).timeout({ response: 9000, deadline: 10000 }).set(_auth2.default.makeHTTPAuth()).send(data).then(function (x) {
      ...
      return console.warn('doPost', e, url, data);
    });
  }
  ...
  var ForestCommon = function (_Component) {
    ...
    function ForestCommon(props) {
      ...
      _forestCore2.default.getObject(props.uid).then(function (o) {
        if (!o) {
          console.error('No bound object', props.uid);return;
        }
        _this.state = o;
        _this.UID = props.uid;
      ...
      value: function getProvider() {
        ...
        return function (props) {
          return _react2.default.createElement(
            Context.Provider,
            { value: {
                object: _this3.object,
                onRead: _this3.onRead,
  ...
  var ForestWidget = function (_Component2) {
    ...
    function ForestWidget() {
      ...
      return _ret = (_temp = (_this4 = _possibleConstructorReturn(this, (_ref2 = ForestWidget.__proto__ || Object.getPrototypeOf(ForestWidget)).call.apply(_ref2, [this].concat(args))), _this4), _this4.onChange = function (value) {
        return _this4.props.onChange(_this4.props.name, value);
      }, _this4.getWebButtonProps = function () {
        return {
          onMouseDown: function onMouseDown() {
            return _this4.onChange(true);
          },
          onMouseUp: function onMouseUp() {
            return _this4.onChange(false);
          },
          onClick: function onClick() {
            _this4.props.onChange(_this4.props.name + '-clicked', true);
            setTimeout(function () {
              _this4.props.onChange(_this4.props.name + '-clicked', false);
            }, 250);
          }
        };
      }, _this4.getAndroidButtonProps = function () {
        return {
          ...
          onLongPress: function onLongPress() {
            _this4.props.onChange(_this4.props.name + '-held', true);
            setTimeout(function () {
              _this4.props.onChange(_this4.props.name + '-held', false);
            }, 250);
          }
        };
      }, _this4.getAllProps = function () {
        return {
          getWebButtonProps: _this4.getWebButtonProps,
          getAndroidButtonProps: _this4.getAndroidButtonProps
        };
