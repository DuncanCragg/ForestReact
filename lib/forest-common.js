(function (global, factory) {
  ...
  function doGet(url) {
    return _superagent2.default.get(url).timeout({ response: 9000, deadline: 10000 }).set(clientPeer ? { Authorization: _auth2.default.makeHTTPAuth(clientPeer, 'http://host/uid-identity') } : {}).then(function (x) {
      return x.body;
    });
  }
  ...
  function doPost(o, url) {
    ...
    return _superagent2.default.post(url).timeout({ response: 9000, deadline: 10000 }).set(clientPeer ? { Authorization: _auth2.default.makeHTTPAuth(clientPeer, 'http://host/uid-identity') } : {}).send(data).then(function (x) {
      return x.body;
    }).catch(function (e) {
    ...
    _createClass(ForestCommon, null, [{
      ...
      value: function wsInit(host, port) {
        ...
        ws.onopen = function () {
          ...
          if (clientPeer) ws.send(_auth2.default.makeWSAuth(clientPeer, 'http://host/uid-identity'));
        };
