(function (global, factory) {
  ...
  function doPost(o, url) {
    ...
    return _superagent2.default.post(url).timeout({ response: 9000, deadline: 10000 }).set(Peer ? { Authorization: _auth2.default.makeHTTPAuth(Peer, Identity) } : {}).send(data).then(function (x) {
      return x.body;
    }).catch(function (e) {
  ...
  var ForestCommon = function (_Component) {
    ...
    _createClass(ForestCommon, null, [{
      ...
      key: 'setPeerIdentity',
      value: function setPeerIdentity(peer, identity) {
        Peer = peer;
        Identity = identity;
      }
    }]);
