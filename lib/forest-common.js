(function (global, factory) {
  ...
  var clientRemote = null;

  function doGet(url) {
    return _superagent2.default.get(url).timeout({ response: 9000, deadline: 10000 }).set(clientRemote ? { Remote: clientRemote } : {}).then(function (x) {
      return x.body;
    }).catch(function (e) {
  ...
  function doPost(o, url) {
    ...
    return _superagent2.default.post(url).timeout({ response: 9000, deadline: 10000 }).set(clientRemote ? { Remote: clientRemote } : {}).send(data).then(function (x) {
      return x.body;
    }).catch(function (e) {
