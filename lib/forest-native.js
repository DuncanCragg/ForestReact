(function (global, factory) {
  ...
  function persist(o) {
    return _reactNative.AsyncStorage.setItem(_forestCore2.default.toUID(o.UID), JSON.stringify(o, null, 2));
  }
  ...
  _forestCore2.default.setPersistence({ persist: persist, fetch: fetch, query: query });
