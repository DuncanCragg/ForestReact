(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['./forest-web', './renderfed'], factory);
  } else if (typeof exports !== "undefined") {
    factory(require('./forest-web'), require('./renderfed'));
  } else {
    var mod = {
      exports: {}
    };
    factory(global.forestWeb, global.renderfed);
    global.evaluatefed = mod.exports;
  }
})(this, function (_forestWeb, _renderfed) {
  'use strict';
  ...
  var uids = _forestWeb2.default.cacheObjects([{ UID: 'uid-1', is: 'guistack', name: 'Forest App', list: ['uid-3', 'uid-2'] }, { UID: 'uid-2', Evaluator: evalFed, is: 'fedexample', counter: 42, topic: 'banana', watching: 'uid-3' }, { UID: 'uid-3', Evaluator: evalFed, is: 'fedexample', counter: 99, topic: 'mango' }]);
  ...
  _forestWeb2.default.renderDOM(React.createElement(_renderfed2.default, { uid: uids[0] }));
});